const routerAddress = "0x99D4e80DB0C023EFF8D25d8155E0dCFb5aDDeC5E";
...
const routerAbi = [
  ...
  {
    inputs: [
      { internalType: "address", name: "addedMaintainer", type: "address" },
    ],
    name: "addMaintainer",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [
      { internalType: "address", name: "removedMaintainer", type: "address" },
    ],
...
module.exports = { routerAddress, routerAbi };
